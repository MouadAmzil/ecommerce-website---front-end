      ...
      <v-col cols="8">
        <template>
          ...
          >
            ...
            <v-divider />
            <v-spacer
              style="padding: 10px 20px; overflow: scroll; height: 73vh"
            >
              ...
              <v-row>
                <v-col cols="2">
                  <v-img
                    ...
                    "
                    src="../../assets/macbook-air-space-gray-select-201810 1.png"
                  ></v-img>
                </v-col>
                <v-col cols="8">
                  <v-spacer style="padding-top: 10px; padding-right: 5px">
                    ...
                    <h5>
                      1768 DH <v-divider class="mx-2" vertical></v-divider>
                ...
                <v-col cols="2">
                  <v-spacer class="">
                    <div
                      class="text-h5"
                      style="text-align: end; font-weight: 500; color: #7e7777"
                    >
                      1768 DH
                    </div>
                  </v-spacer>
                  ...
                  >
                    <!-- <v-action> -->
                    <v-icon style="padding-right: 10px; cursor: pointer"
      ...
      <v-col cols="4">
        <template>
          ...
          >
            ...
            <v-divider />
            <v-spacer
              style="padding: 10px 20px; overflow: scroll; height: 43vh"
            >
              <!-- TODO: Here Put your map for map the all list of panel product in v-row -->
